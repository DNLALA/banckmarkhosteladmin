...
class TransfarDetailsScreen extends StatefulWidget {
  final Transfar issue;

  const TransfarDetailsScreen({super.key, required this.issue});

  @override
  State<TransfarDetailsScreen> createState() => _TransfarDetailsScreenState();
}

class _TransfarDetailsScreenState extends State<TransfarDetailsScreen> {
  ...
  void initState() {
    super.initState();
    requestStatus = widget.issue.transfarStatus;
  }
  ...
  Future<void> _updateStatus(String newStatus) async {
    ...
    var url = Uri.parse('$baseUrl/hostel/transfar-update/${widget.issue.id}/');
